...
FrameBuffer::FrameBuffer(const eFBOTypes& type)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, cfg::GetWindowWidth(), cfg::GetWindowHeight(), 0, GL_RGBA, GL_UNSIGNED_BYTE, NULL);
